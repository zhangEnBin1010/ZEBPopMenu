...
{
    if (!highlightedImage) {
        highlightedImage = [ZEBPopMenu createImageWithColor:[UIColor grayColor]];
    }
...
-(UIView *) makeContenViewFromView:(UIView *)fromView
{
    ...
    for (ZEBPopMenuItem *menuItem in _menuItems){
    ...
    for (ZEBPopMenuItem *menuItem in _menuItems){
        ...
        CGSize titleSize = [menuItem.itemName sizeWithAttributes:@{NSFontAttributeName:[ZEBPopMenu textFont]}];
    ...
    switch (_layoutType) {
        case Horizontal:
        {
            for (ZEBPopMenuItem *menuItem in _menuItems) {
                ...
                [button setBackgroundImage:[ZEBPopMenu highlightedImage] forState:UIControlStateHighlighted];
                ...
                title.textColor = [ZEBPopMenu textColor];
                title.font = [ZEBPopMenu textFont];
                ...
                if (num % kCloumnCount == 0) {
                    ...
                    HLine.layer.borderColor = [ZEBPopMenu SeparationLineColor].CGColor;
                ...
                else
                {
                    ...
                    VLine.layer.borderColor = [ZEBPopMenu SeparationLineColor].CGColor;
        ...
        case Vertical:
        {
            for (ZEBPopMenuItem *menuItem in _menuItems) {
                ...
                if (num < (_menuItems.count -1)) {
                    ...
                    line.layer.borderColor = [ZEBPopMenu SeparationLineColor].CGColor;
...
-(void)showInView:(UIView *)view fromRect:(CGRect)rect layoutType:(LayoutType)type
{
    ...
    //加入覆盖背景
    self.overlayView = [[UIControl alloc] initWithFrame:view.frame];
...
- (void)drawRect:(CGRect)rect {
    ...
    [[UIColor colorWithRed:[ZEBPopMenu backRed]  green:[ZEBPopMenu backGreen] blue:[ZEBPopMenu backBlue] alpha:[ZEBPopMenu backAphla]] set];
    ...
    CGContextSetRGBFillColor (context,  [ZEBPopMenu backRed], [ZEBPopMenu backGreen], [ZEBPopMenu backBlue], [ZEBPopMenu backAphla]);//设置填充颜色
...
{
    ZEBPopMenuItem *menuItem = _menuItems[sender.tag];
