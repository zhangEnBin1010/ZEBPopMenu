...
-(NSArray *)menuItems
{
    ZEBPopMenuItem *item1 = [ZEBPopMenuItem initWithMenuName:@"新建"
                                                         image:[UIImage imageNamed:@"图标1"]
                                                        action:@selector(test1)
                                                        target:self];
    ZEBPopMenuItem *item2 = [ZEBPopMenuItem initWithMenuName:@"新建测试占位符"
                                                         image:[UIImage imageNamed:@"图标2"]
                                                        action:@selector(test2)
                                                        target:self];
    ZEBPopMenuItem *item3 = [ZEBPopMenuItem initWithMenuName:@"新建占位符"
                                                         image:[UIImage imageNamed:@"图标3"]
                                                        action:@selector(test3)
                                                        target:self];
    ZEBPopMenuItem *item4 = [ZEBPopMenuItem initWithMenuName:@"新建占位符占位符"
...
{
    ZEBPopMenu *popupMenu = [[ZEBPopMenu alloc] initWithItems:[self menuItems]];
...
-(void)setBackground:(UIButton *)sender
{
    ...
    [ZEBPopMenu setMenuBackgroundColorWithRed:0.6 green:0.4 blue:0.2 aphla:1];
    ZEBPopMenu *popupMenu = [[ZEBPopMenu alloc] initWithItems:[self menuItems]];
    [popupMenu showInView:self.navigationController.view fromRect:sender.frame layoutType:Horizontal];
    [self.navigationController.view addSubview:popupMenu];
}
...
{
    [ZEBPopMenu setMenuBackgroundColorWithRed:0.6 green:0.4 blue:0.2 aphla:1];
    [ZEBPopMenu setTextColorWithRed:1 green:1 blue:1 aphla:1.0];
    ZEBPopMenu *popupMenu = [[ZEBPopMenu alloc] initWithItems:[self menuItems]];
    [popupMenu showInView:self.navigationController.view fromRect:sender.frame layoutType:Horizontal];
    [self.navigationController.view addSubview:popupMenu];
}
...
-(void)setHighlight:(UIButton *)sender
{
    [ZEBPopMenu setMenuBackgroundColorWithRed:0.6 green:0.4 blue:0.2 aphla:1];
    [ZEBPopMenu setTextColorWithRed:1 green:1 blue:1 aphla:1.0];
    [ZEBPopMenu setHighlightedImage:[UIImage imageNamed:@"cancelBg"]];
    ZEBPopMenu *popupMenu = [[ZEBPopMenu alloc] initWithItems:[self menuItems]];
    [popupMenu showInView:self.navigationController.view fromRect:sender.frame layoutType:Horizontal];
    [self.navigationController.view addSubview:popupMenu];
}
...
{
    [ZEBPopMenu setMenuBackgroundColorWithRed:0.6 green:0.4 blue:0.2 aphla:0.2];
    [ZEBPopMenu setTextColorWithRed:1 green:1 blue:1 aphla:1.0];
    [ZEBPopMenu setHighlightedImage:[UIImage imageNamed:@"cancelBg"]];
    ZEBPopMenu *popupMenu = [[ZEBPopMenu alloc] initWithItems:[self menuItems]];
    [popupMenu showInView:self.navigationController.view fromRect:sender.frame layoutType:Horizontal];
...
{
    [ZEBPopMenu setMenuBackgroundColorWithRed:0 green:0 blue:0 aphla:0.2];
    [ZEBPopMenu setTextColorWithRed:1 green:1 blue:1 aphla:1.0];
    [ZEBPopMenu setHighlightedImage:[UIImage imageNamed:@"cancelBg"]];
    ZEBPopMenu *popupMenu = [[ZEBPopMenu alloc] initWithItems:[self menuItems]];
    [popupMenu showInView:self.navigationController.view fromRect:sender.frame layoutType:Vertical];
